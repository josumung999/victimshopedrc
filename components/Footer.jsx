    ...
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            <span className="ml-2 text-1xl font-bold font-Dongle tracking-wide text-gray-800 dark:text-gray-200 uppercase">
              Victim's Hope DRC
            </span>
          </a>
        ...
        <div>
          <span className="text-2xl font-Dongle font-bold tracking-wide text-gray-900 dark:text-gray-200">
            Social
          </span>
